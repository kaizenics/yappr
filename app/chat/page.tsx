...
export default function PublicChatPage() {
    const [messages, setMessages] = useState<Message[]>([
        ...
        {
            id: "3",
            content: "That's great! Feel free to ask me anything or just have a conversation. I'm here to help!",
    ...
    const handleSearchNewYapper = () => {
        ...
        setTimeout(() => {
            ...
            const newYapper = randomYappers[Math.floor(Math.random() * randomYappers.length)];
                                 ...
                                 <AlertDialog>
                                     ...
                                     <AlertDialogContent>
                                         <AlertDialogHeader>
                                             ...
                                             <AlertDialogDescription>
                                                 Are you sure you want to end the current conversation and search for a new yapper to chat with? Your current chat history will be cleared.
                                             </AlertDialogDescription>
                                         </AlertDialogHeader>
                                         <AlertDialogFooter>
