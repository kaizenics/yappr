                ...
                <div className="flex flex-col items-center justify-center min-h-screen w-full">
                    ...
                    <div className="w-full max-w-lg space-y-3 mt-4">
                        <div className="relative">
                            ...
                            />
                            <button className="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 bg-muted/50 hover:bg-muted/70 rounded-full flex items-center justify-center transition-colors cursor-pointer">
